...
exports.sendWaitlistOfferedEmail = exports.sendClassReminders = void 0;
...
exports.sendWaitlistOfferedEmail = (0, firestore_1.onDocumentUpdated)("bookings/{bookingId}", async (event) => {
    var _a, _b;
